...
namespace Tiles {
    ...
    public partial class HexNode : MonoBehaviour
    {
        ...
        public void Init(HexType hexType, ICoords coords)
        {
            ...
            text.text = $"{coords.MapCoord.x}_{coords.MapCoord.y}";
#endif
        }
        ...
        public void UpdateLineRenderer()
        {
            ...
            for (int i = 0; i < points.Length; i++)
            {
                ...
                {
                    _lineRenderer.SetPosition(i, (Vector2)this.transform.position + RotateV2(points[i], 30f));
                }
            }
        }

        private Vector2 RotateV2(Vector2 v, float degree)
        {
